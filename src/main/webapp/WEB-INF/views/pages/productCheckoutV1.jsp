                        ...
                        <div class="col-12">
                            <div class="tab-btn-wrap tab-style-w font-w3 clearfix">
                                <div href="#" class="tab-btn tab-cart float-left active">
                                    <div class="d-inline-block"><span>購物車</span></div><span id="shoppingcart_length"></span>
                                </div>
                            </div>
                            <!---->
                            <!---->
								          ...
								          function getlocal(){
								              ...
								              if(Shoppingcart==null){
								               ...
								               $.each(JShoppingcart,function(a,b){
								            	   $('#shoppingcart').append(`<tr class="item-row lh-2" index="0">
								            			    <td>
								            		        ...
								            		        <div
								            		            ...
								            		            <div class="show-pc" >
								            		                <a 
								            		                    class="item-name d-block">`+b.ProductName+`
								            		                </a>
								            		            </div>
								            		                ...
								            		                <div
								            		                    class="reminder text-info lh-1 pt-4">
								            		                </div>
								            		                <div class="clearfix"></div>
								            		            </div>
								            		        </div>
								            		    </td>
								            		    <td class="show-pc" style="text-align: center;"><span>`+b.OrderNumber+`</span>
								            		        </select></td>

								            		    <td class="show-pc">
								            		        <div class="item-price pt-1"><span
								            		                class="sell_price">`+(b.OrderNumber*b.StandardCost)+`</span>
								            		        </div>
								            		    </td>
								            		</tr>`)
								                });
                                                                                ...
                                                                                <div>
                                                                                    <div id="store-info" class="row">
                                                                                        ...
                                                                                        <div class="col-md-2 col-4"><a
                                                                                                ...
                                                                                                <div class="d-inline-block">
                                                                                                    <span
                                                                                                        style="font-size: 16px;" onclick="getCities()">選擇門市</span>
                                                                                                </div>
                                                                                            </a></div>
                                                            ...
                                                            <div class="row py-4">
                                                                ...
                                                                <div class="offset-md-7 col-md-5 offset-4 col-8">
                                                                    ...
                                                                    <div class="row mt-4">
                                                                        ...
                                                                        <div class="col text-right" id="totalprice2">
                                                                            NT$ 673
                                                                        </div>
                                                                    </div>
                                                                </div>
